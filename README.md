...
#### Technologies
We will be using **React** as our frontend framework to build this application. However, because the focus of this workshop is AWS, we will be providing the majority of the front code (aside from connecting it to our AWS backend). 
